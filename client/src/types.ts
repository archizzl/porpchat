 ...
 * - bio - The bio an Account user inputed.
...
export type AuthenticationResponse = boolean | { error: string };
...
export interface ServerToClientEvents {
  ...
  threadUpdate: (thread: Thread) => void;
  answerUpdate: (update: AnswerUpdatePayload) => void;
  viewsUpdate: (question: Question) => void;
  voteUpdate: (vote: VoteUpdatePayload) => void;
  commentUpdate: (update: CommentUpdatePayload) => void;
  messageUpdate: (thread: MessageUpdatePayload) => void;
  forumUpdate: (forum: Forum) => void;
}
